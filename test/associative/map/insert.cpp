...
int main() {
        ...
        }
        {
                ...
                clazz::throw_after(2);
                ASSERT_THROW(
                    map.insert(ft::map<int, clazz>::value_type(0, clazz(8))),
                ...
                clazz::throw_after(3);
                ASSERT_THROW(
                    map.insert(ft::map<int, clazz>::value_type(9, clazz(342))),
                    test::too_many_instantiations);
                assert(test::tracking_class::instances() == count);
                clazz::reset();
        ...
        }
        {
                ...
                clazz::throw_after(2);
                ASSERT_THROW(
                    map.insert(ft::map<clazz, int>::value_type(clazz(0), 8)),
                    test::too_many_instantiations);
                assert(test::tracking_class::instances() == count);
                clazz::reset();
                ...
                clazz::throw_after(3);
                ASSERT_THROW(
                    map.insert(ft::map<clazz, int>::value_type(clazz(9), 342)),
                    test::too_many_instantiations);
                assert(test::tracking_class::instances() == count);
                clazz::reset();
        ...
        }
        {
                ...
                ASSERT_THROW(map.insert(ft::map<int, clazz, std::less<clazz>,
                                                allocator>::value_type(34, 2)),
                             std::bad_alloc);
