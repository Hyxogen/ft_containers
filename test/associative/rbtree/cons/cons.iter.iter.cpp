...
int main() {
    ...
    }
    {
        ...
        typedef ft::detail::rbtree<clazz, clazz, ft::detail::use_self<clazz>,
                                   std::less<clazz>,
        ...
        ASSERT_THROW(rbtree tree(test::input_iterator<iterator>(clazz(0)),
                                 test::input_iterator<iterator>(clazz(1000))),
                     test::too_many_instantiations);
        assert(test::tracking_class::instances() == count);
    }
    {
        typedef test::limited_allocator<ft::detail::rbnode<int> > allocator;
        typedef test::range_iterator<int> iterator;
        typedef ft::detail::rbtree<int, int, ft::detail::use_self<int>,
        ...
        ASSERT_THROW(rbtree tree(iterator(0), iterator(1000)), std::bad_alloc);
