// vector(iterator, iterator, iterator) tests
...
int main() {
        ...
        }
        {
                ...
                std::stringstream stream(
                    "If they are input iterators, the complexity");
                std::istream_iterator<std::string> str_it(stream);

                vec.insert(vec.begin(), str_it,
        ...
        }
        {
                ...
                const std::size_t count = test::tracking_class::instances();
                {
                        ...
                        clazz::throw_after(5);
                        ASSERT_THROW(vec.insert(vec.begin() + 10,
        ...
        }
        {
                ...
                const std::size_t count = test::tracking_class::instances();
                {
                        ft::vector<clazz> vec(30);
                        clazz::throw_after(3);
                        ASSERT_THROW(vec.insert(vec.begin() + 25,
                                                input.begin(), input.end()),
                                     test::too_many_instantiations);
                }
                assert(test::tracking_class::instances() == count);
